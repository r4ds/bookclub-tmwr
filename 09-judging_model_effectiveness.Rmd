...
best_models %>% select(metric_name, penalty, mixture) %>% distinct() %>% view()
...
arrow::write_feather(best_models_binary, "bookclub-tmwr_files/best_models_binary.ftr")
```

```{r, warning=FALSE, message=FALSE, fig.height=20}
best_models_binary <- arrow::read_feather("bookclub-tmwr_files/best_models_binary.ftr")
